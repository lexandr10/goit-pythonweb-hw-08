...
class ContactController:
    ...
    async def get_contacts(self, limit: int = 10, offset: int = 0) -> Sequence[Contact]:
    ...
    async def create_contact(self, contact: ContactSchema) -> Contact:
    ...
    async def update_contact(
        self, contact_id: int, contact: ContactUpdateSchema
    ) -> Contact:
    ...
    async def get_contact_by_birthday(self) -> Sequence[Contact]:
        today = date.today()
